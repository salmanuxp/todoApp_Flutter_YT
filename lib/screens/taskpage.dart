...
class _TaskpageState extends State<Taskpage> {
  ...
  void initState() {
    if (widget.task != null) {
      //set Content visibility to true
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (value) async {
                            ...
                            if (value != "") {
                              ...
                              if (widget.task == null) {
                                Task _newTask = Task(title: value, description: null);
                ...
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      controller: TextEditingController()..text = _taskDescription ?? "Enter Description for the task...",
                      decoration: InputDecoration(
